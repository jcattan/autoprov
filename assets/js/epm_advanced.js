...
function epm_advanced_document_ready () {
	...
	var arrayJs = ['assets/autoprov/js/addon/simplescrollbars.js', 'assets/autoprov/js/mode/xml.js', 'assets/autoprov/js/addon/fullscreen.js'];
...
function epm_advanced_tab_oui_manager_bt_new()
{
	...
	if (new_oui.length < "6") {
		...
		var data_ajax = { module: "autoprov", module_sec: "epm_advanced", module_tab: "oui_manager", command: "oui_add", number_new_oui: new_oui, brand_new_oui: new_brand };
...
function epm_advanced_tab_oui_manager_bt_del(id_del)
{
	if (id_del === "") {
		...
		var data_ajax = { module: "autoprov", module_sec: "epm_advanced", module_tab: "oui_manager", command: "oui_del", id_del: id_del };
		if (epm_advanced_tab_oui_manager_ajax(data_ajax) === true) {
