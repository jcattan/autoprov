...
class endpoint_grandstream_GXV3240_phone extends endpoint_grandstream_base {


	public $family_line = 'GXV3240';
...
/* 	function reboot() {
			...
			$server = $this->server[1]['ip'];
                        ...
                        $password = 'admin';
                        $model = 'GXV3240 >';
	                echo exec("/var/www/html/admin/modules/_ap_phone_modules/endpoint/Grandstream/GXV3240/reboot.sh $host $login $password $password2 '$model' $server"); 
