...
class endpoint_htek_UC9XX_phone extends endpoint_htek_base {


	public $family_line = 'UC912';
...
/* 	function reboot() {
			...
			$server = $this->server[1]['ip'];
                        ...
                        $password = 'admin';
                        $model = 'GXV3275 >';
	                echo exec("/var/www/html/admin/modules/_ap_phone_modules/endpoint/htek/UC9XX/reboot.sh $host $login $password $password2 '$model' $server"); 
