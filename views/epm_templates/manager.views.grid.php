	...
	<div class="row">
		<div class="col-sm-12">
			<div id="toolbar-all">
				...
				<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#CloneDlgPoste"><i class='fa fa-copy'></i> <?php echo _('Clone Poste')?></button>
			...
			<table id="mygrid"
				data-url="ajax.php?module=autoprov&amp;module_sec=epm_templates&amp;module_tab=manager&amp;command=list_current_template"
				data-cache="false"
				data-cookie="true"
