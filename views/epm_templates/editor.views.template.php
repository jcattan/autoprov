...
<form action="config.php?display=epm_templates" method="post" id="epm_template_edit_form" name="epm_template_edit_form" class="fpbx-submit">
             		...
             		<div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
								...
								$list_all_files = FreePBX::Autoprov()->epm_templates->edit_template_display_files_list($_REQUEST['idsel'],$_REQUEST['custom']);
								...
								<div class="col-md-12">
                                	<div class="input-group input-group-br files_edit_configs" name="boxselect_<?php echo $row['idrefbox']; ?>" id="boxselect_<?php echo $row['idrefbox']; ?>">
                                        <select 
                                            ...
                                            data-url="ajax.php?module=autoprov&amp;module_sec=epm_templates&amp;module_tab=editor&amp;command=list_files_edit&amp;idsel=<?php echo $_REQUEST['idsel']; ?>&amp;custom=<?php echo $_REQUEST['custom']; ?>&amp;namefile=<?php echo $row['name']; ?>"
											data-cache="false"
                                            data-id = "id"
											data-label = "name"
                                            data-style = ""
	...
	{if condition="$alt != 0"}
        {loop name="alt_configs"}
            ...
            <a href="#" onclick="return popitup('config.php?type=tool&display=epm_config&amp;quietmode=1&amp;handler=file&amp;file=popup.html.php&amp;module=autoprov&amp;pop_type=alt_cfg_edit', '{$value.name}')">
    ...
    {loop name="only_configs"}
        ...
        <a href="#" onclick="return popitup2('config.php?type=tool&display=epm_config&amp;quietmode=1&amp;handler=file&amp;file=popup.html.php&amp;module=autoprov&amp;pop_type=alt_cfg_edit', '{$value.name}')"><code>{$value.name}</code>&nbsp;<i class='icon-pencil blue' ALT='<?php echo _('Edit')?>'></i></a>
        <br/>
    {/loop}
	*/ ?>
