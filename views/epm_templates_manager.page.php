<?php
	...
	$mac_list = "SELECT * FROM autoprov_mac_list";
...
/*
 ...
 $.getJSON("config.php?type=tool&quietmode=1&handler=file&module=autoprov&file=ajax_select.html.php&atype=model_clone",{id: $(this).val()}, function(j){
 var options = '';
